FUNCTION LA_ABS, var1
;+ 
; NAME: LA_ABS
; PURPOSE:
;          calculate the inverseabsolute value of  each element of an array variable, taking
;          into account
...
;------------------------------------------------------------
 ...
 IF N_PARAMS() LT 1 THEN BEGIN
   PRINT, 'CALLING SEQUENCE: output=LA_ABS(var1)'
...
IF cpt GT 0 THEN output(good_values) = abs(var1(good_values))
