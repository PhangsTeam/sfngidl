pro sfng_rebaseline,datadir=datadir,fits_in=fits_in $
...
;
; CALLING SEQUENCE:
;   sfng_rebaseline, fits_in=fits_in, idl_in=idl_in, hdr_in=hdr_in, $
...
sxaddpar,hdr,'HISTORY','Cube rebaselined by sfng_rebaseline.pro'
